      ...
      return (
        ...
        this.each(function () {
            ...
            return (
              ...
              void n.animate({ opacity: 0 }, 500, function () {
                _.css('background', y),
                  ...
                  'iframe' == e.data('vbtype') ? ke() : 'inline' == e.data('vbtype') ? ge() : 'ajax' == e.data('vbtype') ? he() : 'video' == e.data('vbtype') ? pe(s) : (n.html('<img src="' + v + '">'), me()),
                  (U = e),
                  ee(),
                  (m = !1),
          ...
          'ontouchstart' in window
            ? (e(document).on('touchstart', ue), e(document).on('touchmove', ue), e(document).on('touchend', ue))
            : (e(document).on('mousedown', ve), e(document).on('mouseup', ve), e(document).on('mouseout', ve), e(document).on('mousemove', ve)),
